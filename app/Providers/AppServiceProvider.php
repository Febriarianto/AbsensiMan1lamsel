...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $settings = [
            ...
            'student_card_background_url' => null,
            ...
            if (Schema::hasTable('konfigurasi')) {
                $settings = Cache::remember('app_ui_settings_v1', 300, function () use ($settings) {
                    ...
                    $final['website_favicon_url'] = !empty($final['website_favicon_path'])
                        ...
                        : null;
                    $final['student_card_background_url'] = !empty($final['student_card_background_path'])
                        ? Storage::disk('public')->url($final['student_card_background_path'])
                        : null;
