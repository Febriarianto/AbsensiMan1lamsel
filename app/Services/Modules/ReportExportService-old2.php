...
class ReportExportService extends LessonWorkflowService
{
    ...
    protected function buildStudentImportTemplateXlsx(array $headers): string
    {
        ...
        $guide->setCellValue('A1', 'PETUNJUK IMPORT DATA SISWA');
        ...
        $guide->setCellValue('A5', '3. Tanggal Lahir dapat ditulis YYYY-MM-DD.');
    ...
    protected function resolveTemplateDefinition(string $type): ?array
    {
        return match ($type) {
            'siswa' => [
                ...
                ['Siswa', '1234567890', 'Perempuan', '2020-07-17', 'Islam', 'Ayah', 'Ibu', '082279796473', 'Kelas 10', 'Jl. Cabe Raya C1 No.1'],
            ],
            'guru' => [
                ['Username', 'Password', 'Nama', 'Email', 'Kelas', 'Jenis Kelamin', 'Tanggal Lahir', 'Agama', 'No HP', 'Alamat'],
                ['walikelas10', 'walikelas01', 'Wali Kelas 10', 'walikelas10@man1lamsel.sch.id', 'Kelas 10', 'Laki-laki', '1987-10-11', 'Islam', '082279796473', 'Jl. Cabe Raya C1 No.1'],
            ],
            'libur' => [
                ['Tanggal Mulai', 'Tanggal Selesai', 'Kelas (Opsional)', 'Keterangan'],
                ['2026-01-01', '2026-01-01', '', 'Tahun Baru'],
                ['2026-04-01', '2026-04-03', 'Kelas 10', 'Class Meeting Kelas 10'],
            ],
            default => null,
        };
    }
