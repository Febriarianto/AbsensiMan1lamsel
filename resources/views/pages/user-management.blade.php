            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">
                    @if (!empty($viewerCanManageAdminRole))
                        Kelola manajemen user. superadmin hanya bisa dilihat (readonly).
                    @else
                        Kelola akun role bendahara, kamad, dan waka.
                    @endif
                </p>
            </div>
                        ...
                        @forelse ($users as $idx => $user)
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-3 text-center">
                                    @if ($isSuperAdmin)
                                        <span class="px-2 py-1 rounded bg-gray-100 text-gray-600 text-[11px] font-semibold">Readonly</span>
                                    @else
            ...
            <div class="p-6 max-h-[75vh] overflow-y-auto">
                <form id="adminUserForm" method="POST" action="" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block mb-1 text-xs font-bold text-gray-500 uppercase tracking-wide">Username|NIP</label>
                            <input id="adminUserUsername" name="username" placeholder="Username|NIP" required class="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block p-2.5 transition-all">
                        </div>
                        <div>
