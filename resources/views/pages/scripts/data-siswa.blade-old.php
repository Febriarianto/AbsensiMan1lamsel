...
function renderSingleSiswaCardPdf(doc, renderData, layout, tempDiv) {
    ...
    doc.setFont('helvetica', 'bold');
    doc.setFontSize(7.8);
    doc.text('KARTU IDENTITAS MURID', x + 4.5, y + 6);
    ...
    doc.text('-----', qrPanelX + (qrPanelWidth / 2), qrPanelY + qrPanelHeight - 1.8, { align: 'center' });
    ...
    doc.text(`Generate: ${renderData.printedAtLabel}`, x + cardWidth - 4.8, y + cardHeight - 2.5, { align: 'right' });
}
...
function buildSiswaCardPrintSvgMarkup(renderData, qrDataUrl) {
    ...
    return `
        <svg xmlns="http://www.w3.org/2000/svg" width="86mm" height="54mm" viewBox="0 0 86 54" role="img" aria-label="Kartu siswa ${patchedEscapeHtml(renderData.cleanNisn)}">
            ...
            <text x="4.5" y="6" fill="#ffffff" font-family="Helvetica, Arial, sans-serif" font-size="2.752mm" font-weight="700">${patchedEscapeHtml('KARTU IDENTIAS MURID')}</text>
            ...
            <div class="relative w-full animate-fade-in" style="max-width: 660px;">
                <div class="mx-auto w-full" style="max-width: 560px;">
                    <div class="overflow-hidden rounded-3xl border border-sky-100 bg-white shadow-2xl">
                        <div class="px-5 pt-4 pb-3 text-blue">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    <div class="text-[16px] font-bold tracking-wide">KARTU IDENTITAS MURID</div>
                                    <div class="mt-1 text-[16px] font-semibold text-blue">MAN 1 LAMPUNG SELATAN</div>
                                </div>
                                <div class="shrink-0 rounded-full bg-blue-100 px-3 py-1 text-[18px] font-bold text-blue-800">
                                    <span><i>SALINAN</i></span>
                                </div>
                            </div>
                        ...
                        <div class="p-5">
                            <div class="flex flex-col gap-5 md:flex-row md:items-start">
                                <div class="mx-auto rounded-2xl border border-slate-200 bg-slate-50 p-3 md:mx-0 md:shrink-0" style="width: 176px; max-width: 100%;">
                                    ...
                                    <div class="mt-2 text-center text-[11px] font-medium text-slate-500">----</div>
                                </div>
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <div class="mt-3 space-y-2 text-[12px]">
                                        ...
                                        <div class="flex items-start gap-3">
                                            <span class="w-24 shrink-0 font-medium text-slate-500">No Hp</span>
                        ...
                        <div class="border-t border-slate-200 bg-slate-50 px-5 py-3 text-[11px] text-slate-500">
                            <div class="flex items-center justify-between gap-3">
                                <span><i>Generate: ${patchedEscapeHtml(renderData.printedAtLabel)}<i></span>
                                <span>www.man1lamsel.sch.id</span>
                            </div>
                        </div>
                    </div>
                </div>
