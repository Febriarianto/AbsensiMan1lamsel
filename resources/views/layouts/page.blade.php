...
@section('body')
  ...
  @endphp
  <div id="dashboardContainer" class="fixed inset-0 flex h-[100dvh] bg-[#F4F7FA] overflow-hidden">
      ...
      <main id="mainContent" class="flex-1 flex flex-col md:ml-64 h-full min-h-0 relative transition-all duration-300 bg-[#F4F7FA] overflow-hidden">
