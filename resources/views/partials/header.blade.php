          ...
          @endphp
          <header class="h-16 bg-white/90 backdrop-blur-xl sticky top-0 z-20 flex items-center justify-between px-3 sm:px-4 md:px-6 border-b-2 border-[#F2CA00] shadow-sm supports-[backdrop-filter]:bg-white/75">
              ...
              <div class="flex items-center space-x-2 sm:space-x-4">
                  <div class="text-right hidden md:block">
                      <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-0.5"></p>
                  ...
                  <div id="headerProfileDropdownWrap" class="relative">
                      ...
                      <div id="headerProfileMenu" class="hidden absolute right-0 top-[calc(100%+10px)] w-72 rounded-2xl bg-white border border-slate-200 shadow-xl overflow-hidden z-50">
                          ...
                          <div class="py-1.5">
                              ...
                              <a href="mailto:{{ $headerEmail !== '' ? $headerEmail : 'arhasyimi87@gmail.com' }}" class="w-full text-left px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition flex items-center gap-2.5">
                                  <i class="far fa-envelope text-slate-400 w-4 text-center"></i>
                                  <span>Kontak #superadmin</span>
                              </a>
                          </div>
